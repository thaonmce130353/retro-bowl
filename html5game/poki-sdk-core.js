            ...
            (this.gameStarted = !1),
                      ...
                      return v(this, function (n) {
                        switch (n.label) {
                          ...
                          case 3:
                            (t = n.sent()),
                              r.Z.sendMessage(
                                i.Z.message.sendUploadScreenshot,
                                { data: { screenshot: t } }
                              ),
                              (n.label = 4);
                          case 4:
                        ...
                        return v(this, function (n) {
                          ...
                          return (
                            "pokiInspectorRequestCookies" === t.data.type
                              ? (0, p.$)().then(function (e) {
                                  r.Z.sendMessage(
                                    i.Z.message.sendInspectorCookies,
                                    { data: { cookies: e } }
                                  );
                                })
              ...
              (this.setDebug = function (e) {
                ...
                t.endsWith("poki-gdn.com") || "qa-files.poki.com" === t
                  ? e && o.Z.track(i.Z.tracking.debugTrueInProduction)
                  : ((d.Z.debug = e),
              ...
              (this.gameLoadingFinished = function () {
                ...
                clearInterval(window.pokiCancelProgressInterval),
                  o.Z.track(i.Z.tracking.screen.gameLoadingFinished, {
                    ...
                    trackers: ((n = window),
                    (r = []),
                    ("function" != typeof n.ga &&
                      "function" != typeof n.gtag) ||
                      r.push("ga"),
                    n.mixpanel &&
                      "function" == typeof n.mixpanel.track &&
                      r.push("mixpanel"),
                    "function" == typeof n.GameAnalytics &&
                      r.push("gameanalytics"),
              ...
              (this.gameplayStart = function (e) {
                ...
                n.ignoreEvents()
                  ...
                  : ((n.duringGameplay = !0),
                    ...
                    performance.now() - n.lastInteractionTime < 5e3 &&
                      (t = n.lastInteractionEvent),
                    o.Z.track(
                      i.Z.tracking.screen.gameplayStart,
                      f(f({}, e), {
                    ...
                    n.lastGamePlayStop &&
                      (n.lastGamePlayStop > performance.now() - 50 &&
                        n.badEventsCounter++,
              ...
              (this.gameplayStop = function (e) {
                n.ignoreEvents()
                  ...
                  : ((n.duringGameplay = !1),
                    o.Z.track(
                      i.Z.tracking.screen.gameplayStop,
                      f(f({}, e), { fps: n.fpsStats.stats() })
                    ),
                    clearTimeout(n.playerActiveTimeout),
              ...
              (this.roundStart = function (e) {
                void 0 === e && (e = ""),
                  n.ignoreEvents()
                    ? d.Z.debug &&
                      console.error(
                        "roundStart ignored because of too many events"
                      )
                    : ((e = String(e)),
              ...
              (this.roundEnd = function (e) {
                void 0 === e && (e = ""),
                  n.ignoreEvents()
                    ? d.Z.debug &&
                      console.error(
                        "roundEnd ignored because of too many events"
                      )
                    : ((e = String(e)),
              ...
              (this.commercialBreak = function (e) {
                return new Promise(function (t) {
                  ...
                  var o = n.gameStarted
                    ? i.Z.ads.position.midroll
                    : i.Z.ads.position.preroll;
                ...
                return new Promise(function (a) {
                  ...
                  "function" == typeof e
                    ...
                    : (void 0 !== e && (d.category = e),
                      void 0 !== t && (d.details = t),
                      void 0 !== o && (d.placement = o)),
                    setTimeout(function () {
                      d.category &&
                        performance.now() - n.lastInteractionTime < 500 &&
                        (d.from = n.lastInteractionEvent);
              ...
              (this.interactionEvent = function (e) {
                "mousedown" === e.type
                  ...
                  : "keydown" === e.type &&
                    (n.lastInteractionEvent = "keydown-".concat(e.code)),
                ...
                i.forEach(function (e) {
                  if ("true" !== e.getAttribute("data-no-playtest")) {
                    ...
                    a >= n &&
                      ...
                      (a > n && (o = []),
                      o.push({ canvas: e, style: t, index: o.length }),
                      (n = a));
                  }
                }),
                o.sort(function (e, t) {
        ...
        const a = (function () {
          ...
          return (
            (e.sendMessage = function (e, t, n) {
              if (
                (void 0 === n && (n = window.parent), !(0, o.Z)(e, i.Z.message))
              ) {
              ...
              r.Z.gameID &&
                ...
                null == n || n.postMessage({ type: e, content: s }, "*");
            }),
            e
          );
        })();
                ...
                case 0:
                  return "data:," === (t = e.toDataURL())
                    ...
                    : (((n = document
                        ...
                        .getContext("2d", { alpha: !0 })).canvas.width =
                        e.width),
                    ...
                    Promise.resolve(e)
                      .then(function (e) {
                        return (function (e, t) {
                          return T(this, void 0, void 0, function () {
                            return P(this, function (n) {
                              return m(e, HTMLCanvasElement)
                                ? [2, D(e)]
                                : m(e, HTMLVideoElement)
                                ? [2, B(e, t)]
                                : m(e, HTMLIFrameElement)
                                ? [2, M(e)]
                                : [2, e.cloneNode(!1)];
              ...
              switch (r.label) {
                case 0:
                  return ((n = m(e, HTMLImageElement)) && !I(e.src)) ||
                    ...
                    ? [4, _((i = n ? e.src : e.href.baseVal), k(i), t)]
                    : [2];
                case 1:
                  return (
                    (o = r.sent()),
                      ...
                      return (
                        ...
                        [
                          ...
                          x(r, t.fetchRequestInit, function (e) {
                            var t = e.result;
                            return (
                              (n = n.replace(o, "url(".concat(t, ")"))), [o, t]
                            );
                          })
                        ]
                      );
              ...
              return ve(this, function (a) {
                switch (a.label) {
                  ...
                  case 1:
                    return (
                      a.trys.push([1, 3, , 4]),
                      [4, pe(document.body, { quality: 0.95, filter: e })]
                    );
                  case 2:
                    return (o = a.sent()), [3, 4];
                  case 3:
          ...
          I = (function () {
            ...
            return (
              (e.track = function (t, n) {
                ...
                if (
                  (t.includes("pokiTrackingRewardedWeb") && (n = r), f.Z.log)
                ) {
                  if (
                    "test" ===
                    (null ===
              ...
              (e.setupDefaultEvents = function () {
                var t,
                  n =
                    (((t = {})[A.Z.ready] =
                      A.Z.tracking.sdk.status.initialized),
                    ...
                    (t[A.Z.ads.impression] =
                      A.Z.tracking.ads.status.impression),
                    ...
                    (t[A.Z.ads.prebidRequested] =
                      A.Z.tracking.ads.status.prebidRequested),
                    ...
                    (t[A.Z.ads.video.loaderError] =
                      A.Z.tracking.ads.video.loaderError),
                    (t[A.Z.ads.video.buffering] =
                      A.Z.tracking.ads.status.buffering),
                    (t[A.Z.ads.video.progress] =
                      A.Z.tracking.ads.video.progress),
                    (t[A.Z.ads.video.paused] = A.Z.tracking.ads.video.paused),
                    (t[A.Z.ads.video.resumed] = A.Z.tracking.ads.video.resumed),
                    (t[A.Z.tracking.screen.gameplayStart] =
                      A.Z.tracking.screen.gameplayStart),
                    (t[A.Z.tracking.screen.gameplayStop] =
                      A.Z.tracking.screen.gameplayStop),
                    (t[A.Z.tracking.screen.commercialBreak] =
                      A.Z.tracking.screen.commercialBreak),
                    (t[A.Z.tracking.screen.rewardedBreak] =
                      A.Z.tracking.screen.rewardedBreak),
                    t);
            ...
            (e.init = function (t, n) {
              ...
              void 0 === t &&
                ...
                (null ===
                  ...
                  ? ((t = !0), void 0 === n && (n = !1))
                  : ((t = !1), void 0 === n && (n = !1))),
                i.Z.isInspector || "qa-files.poki.com" === a
                  ? ((t = !0), (n = !0))
                  : a.endsWith(".poki-gdn.com") && ((t = !1), (n = !1)),
                i.Z.debugMode && (t = !0),
                i.Z.logMode && (n = !0),
                void 0 === n && (n = t),
                (e.debug = t),
            ...
            d.Z.gameID && !d.Z.isPlayground
              ? l(function (t) {
                  try {
                    ...
                    c.push({ n: e.name, m: n, s: JSON.stringify(e.stack) }),
                      s && s({ name: e.name, message: n, stack: e.stack });
              ...
              (null ===
                (d =
                  null === document || void 0 === document
                    ? void 0
                    : document.referrer) || void 0 === d
                ? void 0
                : d.includes("inspector.poki.dev")) ||
              "1" === (0, o.Z)("inspector"),
  ...
  (a.m = o),
        ...
        if (void 0 !== o)
          for (
            ...
            if (
              ...
              u.getAttribute("data-webpack") == i + o
            ) {
              s = u;
              break;
            }
    ...
    (() => {
      ...
      var d,
        ...
        l = function () {
          n.Z.isPokiIframe &&
            (setTimeout(o.Z.trackSavegames, 1e4),
        ...
        m = function () {
          n.Z.gdprApplies
            ? (t.Z.setRequireConsent(!0),
              (function () {
                if (
                  !(window.__tcfapi || n.Z.isPlayground || n.Z.familyFriendly)
                ) {
                  var e = window.top,
                    t = {};
            ...
            n.Z.ccpaApplies &&
              (!(function () {
                if (
                  !(window.__uspapi || n.Z.isPlayground || n.Z.familyFriendly)
                ) {
                  var e = window.top,
                    t = {};
        ...
        return (
          ...
          (t.prototype.nextTiming = function (e) {
            if (void 0 === this.timingIdx[e])
              throw new Error(
                "AdTimings Error: ".concat(e, " does not have multiple timers")
              );
            this.timingIdx[e] =
      ...
      function G() {
        ...
        return (
          e.searchParams.append("game_id", n.Z.gameID),
          e.searchParams.append("site", "".concat(n.Z.siteID)),
          e.href
        );
      }
      var U = {
      ...
      var V,
        ...
        Q = function (e) {
          return (
            H.includes(e) || H.includes("www.".concat(e)) || e.includes("game")
          );
        };
      function W(e) {
        return function (t, n) {
          var i,
            ...
            a =
              null ===
                (o =
                  null === (i = null == n ? void 0 : n.meta) || void 0 === i
                    ? void 0
            ...
            ? (V || (V = []),
              V.push(
                ""
                  ...
                  .concat(t.toFixed(4), ":")
                  .concat(
                    (null === (r = null == n ? void 0 : n.meta) || void 0 === r
                      ? void 0
                      : r.primaryCatId) || "-"
                  )
              ),
          ...
          if (
            (void 0 === $ &&
              ...
              (d =
                null ===
                  (a =
                    null === (r = null == o ? void 0 : o[s]) || void 0 === r
                      ? void 0
                      : r.video) || void 0 === a
                  ? void 0
                  : a.amazon),
                ...
                var t = ee(
                  ee(
                    ee(
                      ...
                      n.Z.gdprApplies ? { gdpr: { cmpTimeout: 1e4 } } : {}
                    ),
                    n.Z.ccpaApplies
                      ? { params: { aps_privacy: e || "1--" } }
                      : {}
                  ),
                  { signals: re }
                );
              ...
              n.Z.ccpaApplies
                ? window.__uspapi("uspPing", 1, function () {
                    window.__uspapi("getUSPData", 1, function (e, t) {
                      ...
                      if (t) {
                        var i =
                          (null === (n = null == e ? void 0 : e.uspString) ||
                          void 0 === n
                            ? void 0
                            : n.charAt(2)) || "N";
                        "-" === i && (i = "N"), c("1Y".concat(i));
      ...
      var ue = function (e, t) {
        var i = ["US", "CA", "AU"],
          o = {
            "728x90": "/"
              .concat(S, "/")
              .concat(n.Z.device, "_ingame_728x90/")
              .concat(n.Z.siteID, "_")
              .concat(n.Z.device, "_ingame_728x90"),
            "300x250": "/"
              .concat(S, "/")
              .concat(n.Z.device, "_ingame_300x250/")
              .concat(n.Z.siteID, "_")
              .concat(n.Z.device, "_ingame_300x250"),
            "970x250": "/"
              .concat(S, "/")
              .concat(n.Z.device, "_ingame_970x250/")
              .concat(n.Z.siteID, "_")
              .concat(n.Z.device, "_ingame_970x250"),
            "160x600": "/"
              .concat(S, "/")
              .concat(n.Z.device, "_ingame_160x600/")
              .concat(n.Z.siteID, "_")
              .concat(n.Z.device, "_ingame_160x600"),
            "320x50": "/"
              .concat(S, "/")
              .concat(n.Z.device, "_ingame_320x50/")
              .concat(n.Z.siteID, "_")
              .concat(n.Z.device, "_ingame_320x50"),
            "728x90_external": "/"
              .concat(S, "/external_")
              .concat(n.Z.device, "_display_ingame/external_")
              .concat(n.Z.device, "_ingame_728x90"),
            "300x250_external": "/"
              .concat(S, "/external_")
              .concat(n.Z.device, "_display_ingame/external_")
            ...
            return (
                ...
                : e && (a = 13184309),
              {
                bids: [
                  {
                    bidder: "appnexus",
                    params: { placementId: a, supplyType: "web" }
                  },
                  {
                    bidder: "openx",
                    params: { delDomain: "poki-d.openx.net", unit: "540105196" }
                  },
                  ...
                  {
                    bidder: "pubmatic",
                    params: { publisherId: "156838", adSlot: o }
                  },
                  {
                    bidder: "sharethrough",
            ...
            },
            {
              ...
              bids: te(
                ...
                [
                  {
                    bidder: "sharethrough",
                    params: { pkey: Y.rectangle[n.Z.siteID] || Y.rectangle[3] }
                  },
                  {
                    bidder: "triplelift",
            ...
            },
            {
              ...
              bids: te(
                ...
                [
                  {
                    bidder: "sharethrough",
                    params: { pkey: Y.billboard[n.Z.siteID] || Y.billboard[3] }
                  },
                  {
                    bidder: "triplelift",
              ...
              bids: te(
                te(
                  [
                    ...
                    {
                      bidder: "pubmatic",
                      params: { publisherId: "156838", adSlot: "3457872" }
                    },
                    {
                      bidder: "rubicon",
                      params: {
              ...
              bids: te(
                te(
                  [
                    ...
                    {
                      bidder: "pubmatic",
                      params: { publisherId: "156838", adSlot: "3457874" }
                    },
                    {
                      bidder: "rubicon",
                      params: {
                ...
                [
                  {
                    ...
                    params: {
                      pkey:
                        Y.mobile_leaderboard[n.Z.siteID] ||
                        Y.mobile_leaderboard[3]
                    }
                  },
                  {
                    bidder: "triplelift",
              ...
              bids: te(
                te(
                  [
                    ...
                    {
                      bidder: "pubmatic",
                      params: { publisherId: "156838", adSlot: "3457879" }
                    },
                    {
                      bidder: "rubicon",
                      params: {
              ...
              bids: te(
                te(
                  [
                    ...
                    {
                      bidder: "pubmatic",
                      params: { publisherId: "156838", adSlot: "3457877" }
                    },
                    {
                      bidder: "rubicon",
                      params: {
              ...
              bids: te(
                te(
                  [
                    ...
                    {
                      bidder: "pubmatic",
                      params: { publisherId: "156838", adSlot: "3457875" }
                    },
                    {
                      bidder: "rubicon",
                      params: {
        ...
        window.pbjs.que.push(function () {
          ...
          0 ===
            (null === (i = Object.keys(r.floors)) || void 0 === i
              ? void 0
              : i.length) &&
                  ...
                  for (
                    var d = e[s],
                      c =
                        a[
                          (
                            null === (i = null == d ? void 0 : d.mediaTypes) ||
                            void 0 === i
                              ? void 0
                              : i.video
                          )
              ...
              try {
                ...
                if (de()) {
                  ...
                  v.length > 0 && (f = v[0]),
                    f &&
                      (null ===
                        (a =
                          null === (r = null == f ? void 0 : f.meta) ||
                          void 0 === r
                            ? void 0
                            : r.advertiserDomains) || void 0 === a
                        ? void 0
                        : a.length) > 0 &&
                ...
                if (
                  ...
                  if (
                    ...
                    return void T.Z.dispatchEvent(
                      1 === d ? e.Z.ads.video.error : e.Z.ads.completed,
                      { rewardAllowed: !1 }
                    );
                  switch (f.bidder) {
                    case "onetag":
                      h = "https://onetag-sys.com/invocation/?key=".concat(
                        f.videoCacheKey
                      );
                      break;
                    case "rubicon":
                    ...
                    case "poki":
                      ...
                      break;
                    default:
                      h = "https://prebid.adnxs.com/pbc/v1/cache?uuid=".concat(
                        f.videoCacheKey
                      );
                  }
                  (0, D.Z)({
        ...
        if ((se() && A++, de() && A++, se()))
          try {
            window.apstag.fetchBids(
              {
                slots: [
                  { slotID: r ? "Rewarded" : "Midroll", mediaType: "video" }
                ],
                timeout: 1500
              },
              function (e) {
        ...
        var e,
          t =
            (null ===
              ...
              ? void 0
              : e.hostname) || "";
        return "yes" === (0, M.Z)("poki-ad-server")
      ...
      var he,
        ...
        ge = function () {
          return me
            ...
            : "/"
                .concat(S, "/")
                .concat(ve, "_ingame_rewarded_google/")
                .concat(n.Z.siteID, "_")
                .concat(ve, "_ingame_rewarded_google");
        },
        ye = function (n) {
                  ...
                  (function (e) {
                    googletag.defineOutOfPageSlot &&
                      ...
                      Object.keys(e).forEach(function (t) {
                        ...
                        "" !== i &&
                          (null ===
                            (n = null == he ? void 0 : he.setTargeting) ||
                            void 0 === n ||
                            n.call(he, t, i));
                      }));
                  })(n),
          ...
          return (
            (t.prototype.moveThroughWaterfall = function () {
              ...
              if (!1 !== this.running) {
                ...
                if ((this.timing.stopWaterfallTimer(), this.retries < t))
                  return (
                ...
                (this.running = !1),
                  ...
                  this.rewarded
                    ? ye(this.criteria)
                    : T.Z.dispatchEvent(e.Z.ads.error, { message: "No ads" });
              }
            }),
                ...
                (this.adUnitPaths = (function (t) {
                  ...
                  return n.Z.isPokiIframe || n.Z.isPlayground
                    ...
                    : [
                        ""
                          .concat(a, "external_")
                          .concat(o, "_video_1/external_")
                          .concat(o, "_ingame_")
                          .concat(r, "_1"),
                        ""
                          .concat(a, "external_")
                          .concat(o, "_video_2/external_")
                          .concat(o, "_ingame_")
                          .concat(r, "_2")
                      ];
                })(o)),
          ...
          return (
            ...
            (t.prototype.showPauseButton = function () {
              this.showElement(this.pauseButtonContainer),
                this.monetization &&
                  this.pauseButtonContainer.addEventListener(
                    "click",
              ...
              var n = e || null,
                i = function () {
                  if ((n || (n = document.body), n))
                    if ((n.appendChild(null), n === document.body))
            ...
            (t.prototype.startNonIMAFallbackVideo = function (t) {
              ...
              var a = function (t) {
                (n.destroyHouseAds = void 0),
                  ...
                  t ||
                    T.Z.dispatchEvent(e.Z.ads.completed, { rewardAllowed: o });
              };
          ...
          (t.prototype.onAdsManagerLoaded = function (t) {
            ...
            (n.enablePreloading = !0),
              ...
              this.allowedToPlayAd
                ? (this.attachAdEvents(), T.Z.dispatchEvent(e.Z.ads.ready))
                : this.tearDown();
          }),
          ...
          (t.prototype.onAdEvent = function (t) {
            ...
            switch (t.type) {
              ...
              case google.ima.AdEvent.Type.USER_CLOSE:
                this.completeOnce &&
                  ((this.completeOnce = !1),
                  T.Z.dispatchEvent(e.Z.ads.completed, { rewardAllowed: !1 })),
                  this.tearDown();
                break;
          ...
          (this.slotMap = new Map()),
            ...
            (this.requestAd = function (n) {
              ...
              t.Z.track(e.Z.tracking.ads.display.requested, {
                ...
                duringGameplay:
                  null === (i = n.duringGameplay) || void 0 === i
                    ? void 0
                    : i.call(n),
                refresh: n.refreshNumber > 0,
                refreshNumber: n.refreshNumber,
                refreshType:
                  (null === (o = n.criteria) || void 0 === o
                    ? void 0
                    : o.refreshType) || "",
              ...
              var r = 0,
                a = function () {
                  if (!(--r > 0)) {
                    ...
                    n.refreshNumber > 0
                      ? window.googletag.pubads().refresh([n.gptSlot])
              ...
              (0, D.Z)(nt(nt({}, r), { event: "request" })),
                fetch(
                  "https://api.poki.com/ads/houseads/display/"
                    .concat(i.width, "x")
                    .concat(i.height, "?game_id=")
                    .concat(n.Z.gameID, "&site=")
                    .concat(n.Z.siteID)
                )
                  .then(function (e) {
                    return e.json();
                  ...
                  .then(function (n) {
                    (i.innerAdContainer.innerHTML = '<a href="'
                      .concat(
                        n.click_through_url,
                        '" target="_blank"><img src="'
                      )
                      .concat(n.asset, '" alt="house ad" /></a>')),
                      (o.houseAdId = n.id),
        ...
        return (
              ...
              window.googletag
                ...
                .addEventListener("slotRenderEnded", function (i) {
                  ...
                  if (l && l.gptSlot) {
                    var u = i.slot || {},
                      p =
                        (null === (o = u.getResponseInformation) || void 0 === o
                          ? void 0
                          : o.call(u)) || {},
                      A = p.isBackfill,
                      h = p.lineItemId,
                    ...
                    l.onDisplayRendered && l.onDisplayRendered(Z),
                      ...
                      Z && l.backfillHouseads
                        ? n.requestHouseAd(l, I)
                        : t.Z.track(e.Z.tracking.ads.display.impression, I);
                  }
                }),
                window.googletag
                  .pubads()
                  .addEventListener("impressionViewable", function (i) {
                    var o,
                      r,
                      a,
                      s,
                    ...
                    ((null ===
                      (r =
                        null === (o = null == i ? void 0 : i.slot) ||
                        void 0 === o
                          ? void 0
                          : o.getAdUnitPath()) || void 0 === r
                      ? void 0
                      : r.includes("ingame_rewarded_google")) ||
                      (null ===
                        (s =
                          null === (a = null == i ? void 0 : i.slot) ||
                          void 0 === a
                            ? void 0
                            : a.getAdUnitPath()) || void 0 === s
                        ? void 0
          ...
          (o.prototype.renderAd = function (e) {
            ...
            w.refreshNumber > 0 && (k = w.innerAdContainer),
              k ||
                (o.appendChild(w.innerAdContainer),
                  ...
                  ? n.requestHouseAd(w, {
                      ...
                      refreshType:
                        (null === (e = w.criteria) || void 0 === e
                          ...
                          : e.refreshType) || "",
                      duringGameplay:
                        null === (t = w.duringGameplay) || void 0 === t
                          ? void 0
                          : t.call(w),
            ...
            (i.prototype.allBidsBack = function (n) {
              ...
              if (d) {
                ...
                if (l) {
                  l.appendChild(c);
                  var u =
                    null === (i = null == c ? void 0 : c.contentWindow) ||
                    void 0 === i
                      ? void 0
                      : i.document;
                  if (!u)
                  ...
                  var f,
                    ...
                    v =
                      ((f =
                        null === (o = null == d ? void 0 : d.amznTargetting) ||
                        void 0 === o
                          ? void 0
                          : o.amznbid),
                      q[f] || 0);
                  v > h
                    ? ((m =
                        null === (r = null == d ? void 0 : d.amznTargetting) ||
                        void 0 === r
                          ? void 0
                          : r.amnzp),
                      (A = F[m] || "Amazon"),
                  ...
                  t.Z.track(e.Z.tracking.ads.display.impression, {
                    ...
                    duringGameplay:
                      null === (a = d.duringGameplay) || void 0 === a
                        ? void 0
                        : a.call(d),
          ...
          function o() {
            ...
            (this.autoStartOnReady = !1),
              ...
              (this.sdkNotBootedButCalled = function () {
                return (
                  !(!o.strictConsentMode || o.monetizationCoreLoaded) ||
                  (!o.strictConsentMode &&
                    !o.sdkBooted &&
                  ...
                  (e.experiment = t),
                    n.Z.contentGameID &&
                      (e.expid_content_gameid = ""
                        .concat(t, "|")
                        .concat(n.Z.contentGameID));
                }
                return (
                  n.Z.specialCondition &&
                  o.specialConditions &&
                  o.specialConditions.includes(n.Z.specialCondition)
                  ...
                  (function () {
                            ...
                            return (
                              ...
                              (s =
                                (null ===
                                  (t =
                                    null ===
                                      (e = a.querySelector("ClickThrough")) ||
                                    void 0 === e
                                      ? void 0
                                      : e.textContent) || void 0 === t
                                  ? void 0
                                  : t.trim()) || ""),
                              (d =
                                (null ===
                                  (i =
                                    null ===
                                      (n = a.querySelector("Duration")) ||
                                    void 0 === n
                                      ? void 0
                                      : n.textContent) || void 0 === i
                                  ? void 0
                                  : i.trim()) || "00:00:11"),
                              (c = d.split(":")),
                                  ...
                                  var t,
                                    n =
                                      ...
                                      void 0 === t
                                        ? void 0
                                        : t.trim()) || "";
                                  n.includes("advertisement.h264_medium.mp4") &&
                                    (u = n);
                                }),
                    ...
                    .catch(function () {
                      y.Z.sendMessage(e.Z.message.sendCommand, {
                        ...
                        T.Z.dispatchEvent(
                          e.Z.ads.error,
                          lt(lt({}, t), { message: "HouseAd playback error" })
                        );
                    });
              }),
          ...
          return (
            ...
            (o.prototype.loadPokiSettings = function () {
              ...
              i.Z.init(d, u),
                ...
                l(),
                (this.playerSkin = new Ue({ wrapper: p })),
                window.addEventListener(
                  "resize",
                    ...
                    if ("fulfilled" === l.status) {
                      ...
                      if (A) {
                        n.Z.gameID || (0, n.w)("gameID", A.gameID),
                          A.cachedContentGameID &&
                            (0, n.w)("contentGameID", A.cachedContentGameID),
                        ...
                        var h = (function (i) {
                            ...
                            if (
                              i.playtestVersion &&
                              i.playtestVersion !== n.Z.versionID
                            )
                              return { lobbyID: void 0, record: !1 };
                            r =
                              (null == i ? void 0 : i.playtestLobbyID) ||
                              void 0;
                            var a =
                              (null == i ? void 0 : i.playtestRecord) || !1;
                            if (r || a) {
                              var s =
                                "4g" ===
                                  (null === (o = navigator.connection) ||
                                  void 0 === o
                                    ? void 0
                                    : o.effectiveType) &&
                                !(0, w.Z)() &&
                              ...
                              if (
                                (t.Z.track(e.Z.tracking.playtest.showModal, {
                                  show: s
                                }),
                                s)
                              )
                                return { lobbyID: r, record: a };
                            }
                            return { lobbyID: void 0, record: !1 };
                          })(A),
                          v = h.lobbyID,
                    ...
                    case 2:
                      return (
                        ...
                        n.Z.familyFriendly || n.Z.nonPersonalized
                          ? (n.Z.familyFriendly &&
                              this.display.enforceFamilyFriendlyFlow(),
                            (0, n.w)("nonPersonalized", "true"),
                            this.display.enforceNonPersonalized())
                          : w.push(
                              (0, b.Z)(
                                "https://a.poki.com/prebid/prebid8.36.0-2.js"
                              ),
                              (0, b.Z)(
                                  ...
                                  window.googletag.cmd.push(function () {
                                    googletag
                                      ...
                                      .addEventListener(
                                        ...
                                        function (n) {
                                          t.Z.track(
                                            e.Z.tracking.ads.rewardedWeb.ready
                                          ),
                                        ...
                                        .addEventListener(
                                          ...
                                          function (n) {
                                            ...
                                            ge() ===
                                              ...
                                              T.Z.dispatchEvent(
                                                e.Z.ads.video.startHouseAdFlow
                                              ));
                                          }
                                        ),
                                      googletag
            ...
            (o.prototype.requestAd = function (o) {
              ...
              if (
                (t.Z.track(
                  y === e.Z.ads.position.rewarded
                    ? e.Z.tracking.screen.rewardedBreak
                    : e.Z.tracking.screen.commercialBreak,
                  lt(lt({}, o.rewardedKVs), b)
                ),
                ...
                this.registerHandler("onStart", function (t) {
                  T.Z.dispatchEvent(e.Z.playtest.startVideo, { position: y }),
                    f && f(t);
                }),
                ...
                if (this.displayOnly)
                  T.Z.dispatchEvent(
                    e.Z.ads.error,
                    lt(lt({}, b), { message: "Video disabled" })
                  );
                else {
                  if (!this.sdkBooted)
                    return (
                  ...
                  if (
                    (null ===
                      (s =
                        null === (a = this.ima) || void 0 === a
                          ? void 0
                          : a.isAdRunning) || void 0 === s
                      ? void 0
                      : s.call(a)) ||
                    (null ===
                      (c =
                        null === (d = this.waterfall) || void 0 === d
                          ? void 0
                          : d.isRunning) || void 0 === c
                      ? void 0
                      : c.call(d))
                  )
                    T.Z.dispatchEvent(e.Z.ads.busy, b);
                  else if (
                    y !== e.Z.ads.position.preroll ||
                    ht.prerollPossible()
                  )
                    if (y === e.Z.ads.position.rewarded || ht.requestPossible())
                      if (
                        ...
                        T.Z.dispatchEvent(
                          e.Z.ads.limit,
                          lt(lt({}, b), { reason: e.Z.info.messages.disabled })
                        );
                      else {
                        if (
                          this.strictConsentMode &&
                      ...
                      T.Z.dispatchEvent(
                        e.Z.ads.limit,
                        lt(lt({}, b), { reason: e.Z.info.messages.timeLimit })
                      );
                  else
                    T.Z.dispatchEvent(
                      e.Z.ads.limit,
                      lt(lt({}, b), { reason: e.Z.info.messages.prerollLimit })
                    );
                }
            ...
            (o.prototype.displayAd = function (t) {
              ...
              return (
                ...
                t.platformAd &&
                  (delete t.criteria.p4d_game_id_cond,
                    ...
                    ? o
                      ? void 0 === window.googletag
                        ? (T.Z.dispatchEvent(e.Z.ads.error, {
                          ...
                          !1)
                        : this.adSettings.countryExclusion.includes(n.Z.country)
                        ? (T.Z.dispatchEvent(e.Z.ads.limit, {
            ...
            (o.prototype.startAd = function () {
              this.sdkNotBootedButCalled() ||
                (this.adReady
                  ? (this.resizeVideoAd(), this.ima.startPlayback())
                  : T.Z.dispatchEvent(e.Z.ads.error, {
              ...
              T.Z.addEventListener(e.Z.ready, function () {
                ...
                T.Z.addEventListener(e.Z.ads.started, function () {
                  t.playerSkin.hideSpinner(),
                    t.callHandler("onStart", { type: e.Z.ads.limit });
                }),
                ...
                T.Z.addEventListener(e.Z.ads.inFlight, function (t) {
                  ...
                  delete i.onFinish,
                    null === (n = t.onFinish) ||
                      ...
                      n.call(
                        t,
                        lt(lt({}, i), { type: e.Z.ads.busy, rewardAllowed: !1 })
                      );
                }),
